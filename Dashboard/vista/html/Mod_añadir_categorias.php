        ...
        <div class="sub-central-box">
            ...
            <div class="super-form">
                <div class="formulario">
                    ...
                    <hr>
                    <form action="Mod_añadir_categorias.php" method="post">
                        <label for="">Nombre categoría:</label>
                        <input type="text" name="nombre" id="nombre" placeholder="Nombre categoría">
    
                        <label for="">Cantidad de Subcategorías:</label>
                        <input type="number" name="Cantidad" id="Cantidad" min="1" max="3" placeholder="Cantidad">
                    ...
                    if(isset($_POST['nombre'])){
                        ...
                        $cantidad=$_POST['Cantidad'];
                            ...
                            $sql = "INSERT INTO tbl_categoria (Cat_Nombre, FK_ID_SubCategoria) values ('$nombre', '1')";
