...
<head>
    ...
    <!-- CSS personalizado -->
    <link rel="stylesheet" href="../css/Style_Mod_reporte_ventas.css">
...
<body>
    ...
    <div class="central-box">
        <!--Nombre página-->
        <div class="name-page">
            <a href="Mod_reporte_ventas.php"><i class="name-page-icon fas fa-file-invoice-dollar"></i></a>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="table-responsive mt-4 mb-4">
                            <table id="tablaReporte" class="table table-striped table-bordered table-condensed"
                                style="width:100%">
    ...
    <script src="../js/repoteVentasTable.js"></script>
</body>
