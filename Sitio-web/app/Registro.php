<?php
    ...
    try {
        ...
        $statement = $conexion->prepare("INSERT INTO tbl_cliente (Cl_Nombre, Cl_Apellido, Cl_Dirección, Cl_Telefono, Cl_Pedidos_realizado, 
        Cl_email, Cl_password) VALUES ('$Cl_Nombre', '$Cl_Apellido', '$Cl_Dirección', '$Cl_Telefono','$Cl_Pedidos_realizado', '$Cl_email', '$Cl_password')");
